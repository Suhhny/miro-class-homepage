...
class Activity extends Component {
    render(){
        return(
            <div style={{ backgroundColor: "#5a5c5e", margin: "7px 0px 7px 0px", width: "550px", height: "80px", borderRadius: "8px",
                ...
                <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", flexGrow: "8"}}>
                    <div style={{ display: "flex", flexDirection: "row", margin: "0", alignItems: "flex-end"}}>
                        <p style={{ margin: "0", color: "#fff000", fontSize: "20px"}}>박기덕</p>
                        <p style={{ margin: "0", color: "#ababab", fontSize: "13px"}}>님이 내 게시물에 댓글을 남겼습니다.</p>
                    </div>
                    <p style={{ margin: "0 0 0 5px", color: "#ffffff"}}>글 잘 읽었읍니다..</p>
                </div>
